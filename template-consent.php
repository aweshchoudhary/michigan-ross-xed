...
<article class="md:px-44 md:py-10 px-5 py-10">
    <div>
        ...
        <div class="container mx-auto">
            <?php echo do_shortcode('[wpforms id="532" title="false"]'); ?>
        </div>
        <div class="md:mt-20 mt-10">
            ...
            <div>
                ...
                <div>
                    ...
                    <p> Only your email id and name will be shared with fellow participants to accomplish the collaborative assignment as part of your learning journey.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p> The usual channels of communication through our Program LMS application will continue to be accessible. You will still be able to connect and collaborate over this application.</p>
                </div>
                <div>
